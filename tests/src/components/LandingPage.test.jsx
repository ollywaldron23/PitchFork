...
describe('LandingPage component', () => {
  ...
  it('submits idea and shows feedback after fetch', async () => {
    ...
    fireEvent.change(screen.getByPlaceholderText(/Type your idea/i), {
      target: { value: 'This is a fully valid idea that is definitely longer than fifty characters.' },
    })
    fireEvent.click(screen.getByText(/pitch/i))
    ...
    await waitFor(() => {
      expect(global.fetch).toHaveBeenCalledWith(
        ...
        expect.objectContaining({
          ...
          body: JSON.stringify({ idea: 'This is a fully valid idea that is definitely longer than fifty characters.', jokeMode: false }),
        })
      )
    })
